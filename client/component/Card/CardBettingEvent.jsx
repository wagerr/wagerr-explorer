      ...
      <div className="card">
        <div className="card__title direction-row space-between">
          <div className="font-17">
            {props.data.tournament} (Event ID: {props.data.event_id})
          </div>
          <div className="font-17 card__title__last">
            {`${moment
              .unix(parseInt(props.data.starting))
              .local()
        ...
        <div className={props.data.disabled ? "card-disabled" : ""}>
          <div className="card__content direction-row">
            <div className="card__content__title w-40 m-20 font-weight-500">
              {props.data.teams.home}
            </div>
            <button
              className="w-20 card__content__button align-center"
              onClick={() => PubSub.publish("event-clicked", [props.data, 1])}
            >
            ...
            >
              {props.data.odds[1].spreadHome == 0 ? (
                <div className="align-center"> - </div>
              ) : (
                <div className="direction-row space-between p-12">
                  <div>
                    {props.data.odds[1].spreadPoints < 0
                      ? props.data.odds[1].spreadPoints
                      : "+" + props.data.odds[1].spreadPoints}
                  </div>
            ...
            >
              {props.data.odds[2].totalsOver == 0 ? (
                <div className="align-center"> - </div>
              ) : (
                <div className="direction-row space-between p-12">
          ...
          <div className="card__content direction-row m-t--16">
            <div className="card__content__title w-40 m-20 font-weight-500">
              {props.data.teams.away}
            </div>
            <button
              className="w-20 card__content__button align-center"
              onClick={() => PubSub.publish("event-clicked", [props.data, 2])}
            >
            ...
            >
              {props.data.odds[1].spreadAway == 0 ? (
                <div className="align-center"> - </div>
              ) : (
                <div className="direction-row space-between p-12">
                  <div>
                    {props.data.odds[1].spreadPoints < 0
                      ? "+" + Math.abs(props.data.odds[1].spreadPoints)
                      : "-" + props.data.odds[1].spreadPoints}
                  </div>
            ...
            >
              {props.data.odds[2].totalsUnder == 0 ? (
                <div className="align-center"> - </div>
              ) : (
                <div className="direction-row space-between p-12">
          ...
          <div className="card__content direction-row m-t--16">
            ...
            <button
              className="w-20 card__content__button align-center"
              disabled={props.data.odds[0].mlDraw == 0}
              onClick={() => PubSub.publish("event-clicked", [props.data, 3])}
            >
              {props.data.odds[0].mlDraw == 0 ? "-" : props.data.odds[0].mlDraw}
            </button>
