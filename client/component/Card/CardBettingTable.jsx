    ...
    return (
      <div className='card'>
          <div className="card__title direction-row space-between">
            ...
            <div className='font-17'>Thu, Dec 5th 10:02 PM (+07:00 + 07)</div>
          </div>
          ...
          <div className="card__content direction-row">
            <div className='w-40 m-20 font-weight-500'>Fiji 7s</div>
          ...
          <div className="card__content direction-row m-t--16">
            <div className='w-40 m-20 font-weight-500'>Japan 7s</div>
            <div className='w-20 card__tag align-center'>1.02</div>
            <div className='w-20 card__tag direction-row space-between p-12'>
              <div>+28.5</div>
              <div>2.26</div>
          ...
          <div className="card__content direction-row m-t--16">
            <div className='w-40 m-20 font-weight-500'>Draw</div>
