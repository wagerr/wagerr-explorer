...
class App extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      searches: [],
      toggleSwitch:
        localStorage.getItem("toggleCompletedAndOpen") != undefined
          ? localStorage.getItem("toggleCompletedAndOpen") == "true"
          : false,
      toggleSwitchOdds:
        localStorage.getItem("toggleOddsFee") != undefined
          ? localStorage.getItem("toggleOddsFee") == "true"
          : false,
      toggleSwitchOddsStyle:
        localStorage.getItem("toggleOddsStyle") != undefined
          ? localStorage.getItem("toggleOddsStyle") == "true"
          : false,
    };
  ...
  render() {
    ...
    const { toggleSwitch, toggleSwitchOdds, toggleSwitchOddsStyle } =
      this.state;
          ...
          <Switch>
            ...
            <Route
              ...
              render={(props) => (
                <BetParlays
                  {...props}
                  onParlaySearch={this.handleParlaySearch}
                  handleSearch={this.handleSearch}
                  handleRemove={this.handleRemove}
                  searches={this.state.searches.reverse()}
                  handleToggleChange={this.handleToggleChange}
